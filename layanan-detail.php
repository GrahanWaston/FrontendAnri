...
<section class="wrapper image-wrapper bg-image bg-overlay text-white" data-image-src="./assets/img/photos/bg2.jpg">
    <div class="container pt-19 pt-md-18 pb-18 pb-md-18 text-center">
        <div class="row">
            <div class="col-md-10 col-lg-8 col-xl-7 col-xxl-6 mx-auto">
            <h1 class="display-1 text-white mb-3">Layanan Detail</h1>
            <p class="lead fs-lg px-md-3 px-lg-7 px-xl-9 px-xxl-10">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sequi, officia?</p>
            </div>
            <!-- /column -->
        </div>
        <!-- /.row -->
    ...
    <div class="container pt-14 pb-12 pt-md-16 pb-md-14">
        <div class="row gx-lg-8 gx-xl-12 gy-10 mb-lg-22 mb-xl-24 align-items-center">
            ...
            <div class="col-lg-5">
                ...
                <h3 class="display-6 mb-5">Layanan yang kami tawarkan dirancang khusus untuk memenuhi kebutuhan Anda.</h3>
        ...
        <div class="row text-center">
            <div class="col-lg-9 mx-auto">
                ...
                <h3 class="display-4 mb-0 text-center px-xl-10 px-xxl-15">
                    Cari tahu semua yang perlu Anda ketahui tentang membuat model proses bisnis
                </h3>
    ...
    <div class="container py-14 py-md-16">
        <div class="row gx-lg-8 gx-xl-12 gy-10 mb-14 mb-md-16 align-items-center">
            ...
            <div class="col-lg-5">
                ...
                Kami membawa solusi cepat untuk membuat kehidupan pelanggan kami lebih mudah.
                </h3>
        ...
        <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
            ...
            <div class="col-lg-5">
                ...
                Kami membuat pengeluaran Anda bebas stres bagi Anda untuk memiliki kontrol yang sempurna.
                </h3>
                    ...
                    <div class="col-xl-6">
                        <ul class="icon-list bullet-bg bullet-soft-primary mb-0">
                            <li><span><i class="uil uil-check"></i></span><span>Etiam porta euismod malesuada
                                    mollis.</span></li>
                            <li class="mt-3"><span><i class="uil uil-check"></i></span><span>Vivamus sagittis lacus vel
                                    augue rutrum.</span></li>
                        </ul>
                    </div>
                    <!--/column -->
                </div>
    ...
    <div class="container pt-0 pb-14 pt-md-16 pb-md-18">
        <div class="row">
            <div class="col-lg-10 col-xl-9 col-xxl-8 mx-auto">
                <h2 class="fs-15 text-uppercase text-muted mb-3">Bergabung dengan kita</h2>
                <h3 class="display-4 mb-8 px-lg-12">
                Kami dipercaya oleh lebih dari 5000+ klien. Bergabunglah dengan mereka sekarang dan kembangkan bisnis Anda.
                </h3>
            </div>
            <!-- /.row -->
        </div>
